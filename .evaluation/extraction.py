""" Color 256 pallete extraction source and related functions.
Place to hold content that may be used in the future but is not related to the library's internal functioning.
NOT meant for use.
"""

#import sys; print(sys.version)

_extract_sys_colors ="""0	Black (SYSTEM)	#000000	rgb(0,0,0)	hsl(0,0%,0%)
...
def _extract_from_source(text: str):
    next=text.find('rgb(')
    out=[]
    while next!=-1:
        close=text.find(')',next)
        value=text[next+4:close].split(',')
